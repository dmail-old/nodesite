var NodeView = new Class({
	...
	getDom: function(what){
		switch(what){
			case 'li': return this.element;
			case 'ul': return this.childrenView.element;
			case 'div': return this.element.getChild(what);
			default: return this.getDom('div').getChild(what);
		}
	},
...
document.on({
	'view:focus': function(e){ View(e).scrollTo(); },
