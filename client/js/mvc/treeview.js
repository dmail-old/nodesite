...
var NavViewController = new Class({
	...
	getPageCount: function(element){
		...
		var count = parseInt(total / this.view.getLine(element)) - 1;
...
var MultipleSelectionViewController = new Class({
	...
	events: {
		'view:naviguate': function(e){
			var view = View(e), e = e.detail.args[1];
...
var LightedViewController = new Class({
	...
	events: {
		'view:light': function(e){
			var current = this.lighted;
			this.lighted = View(e);
			if( current && current != this.lighted ){
				current.unlight(e);
			}
		},
		
		'view:unlight': function(e){
			if( this.lighted == View(e) ) delete this.lighted;
		},
	},
...
var TreeView = new Class({
	...
	events: {
		mouseover: function(e){
			...
			if( view ) view.light(e);
			else this.lighted.unlight(e);
		},
		
		mouseout: function(e){
			var view = View(e.relatedTarget);
			if( !view || !this.checkView(view, e) ) this.lighted.unlight(e);
		},
