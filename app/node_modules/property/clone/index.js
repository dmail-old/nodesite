...
if( 'getOwnPropertyDescriptor' in Object ){
	property.append(clone, {
		...
		cloneProperty: function(name, clone, object){
			...
			var cloneDescriptor = property.cloneDescriptor(objectDescriptor);

			if( 'value' in objectDescriptor ) cloneDescriptor.value = this.cloneProperties(objectDescriptor.value);
			
			Object.defineProperty(clone, name, cloneDescriptor);		
		}
	});
}
