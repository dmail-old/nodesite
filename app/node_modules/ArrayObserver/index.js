...
var ArrayObserver = {
	...
	Observer: require('ObjectObserver'),
	...
	init: function(array, listener, bind){
		this.array = array;
		this.methods = {};
		...
		if( arguments.length > 1 ){
			this.setListener(listener, bind, supressNotify);
		}
	},

	setListener: function(listener, bind, supressNotify){
