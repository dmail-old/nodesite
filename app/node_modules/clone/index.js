...
property.mergeKey = function(key, object){
	// comment on fait sans pouvoir lire la valeur??

	if( typeof value == 'object' && value !== null ){
		var current = this[key];

		if( typeof current == 'object' && current !== null ){
			property.eachOwnKey(value, property.mergePair, current);
		}
		else{
			property.setKeyClone.apply(this, arguments);
		}
	}
	else{
...
property.merge = function(object){
	property.iterateKey(Array.slice(arguments, 1), 'eachOwnKey', property.mergeKey, object);
	return object;
};
*/