...
var PropertyPathObserver = proto.extend.call(PropertyPath, {
	partPrototype: require('./PartObserver'),
	closed: false,

	constructor: function(path, model, listener, bind, id, suppressNotify){
		PropertyPathObserver.super.constructor.call(this, path);
