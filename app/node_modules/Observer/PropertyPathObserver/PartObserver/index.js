...
var Part = PropertyPath.partPrototype;
var proto = require('@dmail/proto');

var PartObserver = proto.extend.call(Part, {
	...
	constructor: function(name, model, listener, bind, id){
		PartObserver.super.constructor.call(this, name);
	...
	setModel: function(model){
		...
		// object, function, primitive
			...
			// object, function
				...
				this.observer = this.Observer.create(model, this.name).observe(this.onchange, this);
