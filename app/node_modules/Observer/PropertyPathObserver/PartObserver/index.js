...
var Part = PropertyPath.prototype.partPrototype;
var proto = require('proto');

var PartObserver = proto.extend(Part, {
	...
	setModel: function(model){
		...
		// object, function, primitive
			...
			// object, function
				...
				this.observer = new this.Observer(model, this.name).observe(this.onchange, this);
