...
mais même custompropertydefinition ne sera ptet pas utile donc bon
*/
...
var ObjectObserver = proto.create({
	...
	get: function(name){
		...
		if( name in this.propertyObservers ){
			...
			observer = new PropertyObserver(this, name);
...
var PropertyObserver = proto.create({
	...
	constructor: function(objectObserver, name){
		if( !(objectObserver instanceof ObjectObserver) ){
			objectObserver = new ObjectObserver(objectObserver);
		}
		else{
	...
	open: function(){
		...
		if( Object.prototype.hasOwnProperty.call(this.object, this.name) ){
			...
			if( this.parentProto && this.parentProto != Object.prototype ){
				this.protoObserver = new PropertyObserver(this.parentProto, this.name);
