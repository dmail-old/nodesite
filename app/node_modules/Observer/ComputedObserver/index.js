var ComputedObserver = {
	Observer: require('Observer').PropertyAccessorObserver,
	observers: null,
	values: null,
	value: undefined,
	size: 0,
	...
	init: function(combinator, combinatorBind){
		this.observers = {};
		this.values = {};
	...
	observe: function(name, model, path, supressResolve){
		...
		this.observers[name] = this.Observer.new(path, model, this.onchange, this, name);
		if( supressResolve ){
			this.closed = false;
		}
	},
