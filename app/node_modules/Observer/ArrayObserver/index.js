...
- delete array[index] due to ObjectChangeEmitter limitations (PropertyObserver cant detect delete)
...
var ArrayObserver = proto.extend({
	mutators: require('./mutators'),
	Observer: require('Observer').ObjectObserver,
	...
	constructor: function(array, listener, bind, supressNotify){
		this.array = array;
		this.methods = {};
		this.observer = this.Observer.create(array);
		this.wrapAll();
