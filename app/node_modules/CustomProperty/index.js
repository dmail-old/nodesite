...
API.defineCustomProperty({}, 'fullName', {
	...
	onchange: function(change){} // called each time the propertyvalue has changed (because of parent or self)
...
var API = {
	...
	addPropertyListener: function(object, name, listener, capture){
		/*
		capture = true -> on catch les changements sur le parent mais pas sur les enfants
		capture = false -> on catch les changements sur le parent et sur les enfants
		*/
		return CustomPropertyDefinition.observeProperty(object, name, listener);
	},

	removePropertyListener: function(object, name, listener, capture){
		return CustomPropertyDefinition.unObserveProperty(object, name, listener);
	}
};
