var Part = require('ObjectPath/pathPart');
...
var PartObserver = Part.extend({
	...
	listener: null,
	emitter: null,
	alias: undefined, // alias of this PartObserver, usefull for listener callback

	create: function(name, model, listener, bind, alias){
		Part.create.call(this, name);

		if( arguments.length > 1 ){
			this.setModel(model);
			if( arguments.length > 2 ){
				this.listenChange(listener, bind, alias);
			}			
		}
	},
	...
	notify: function(change){
		...
		if( typeof this.listener == 'function' ){
			this.listener.call(this.bind, change, this.alias);
		}
	},
	...
	listenChange: function(listener, bind, alias, supressNotify){
	...
	setModel: function(model){
		...
		// object, function, primitive
			...
			// object, function
				...
				this.emitter = ObjectChangeEmitter.new(model);
