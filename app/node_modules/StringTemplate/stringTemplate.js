...
var StringTemplate = {
	...
	empty: function(token){
		return this.open + token + this.close;
	},

	replace: function(tokens, replacer, data){
		...
		for(;i<j;i+=2){
			token = tokens[i];
			result+= replacer.call(this, data, token, i);
			result+= tokens[i + 1];
		}
	...
	render: function(data){
		return this.replace(this.parse(), this.replacer, data);
	}
};
