...
var StringTemplate = proto.create({
	...
	exec: function(object, map, bind){
		...
		var expressions = this.expressions, i = 0, j = expressions.length, values = new Array(j), value;

		this.getter = this.getGetter(object);	

		for(;i<j;i++){
			value = this.getter(expressions[i], object, i);
