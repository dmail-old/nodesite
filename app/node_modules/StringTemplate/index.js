...
var StringTemplate = proto.create({
	...
	init: function(string){
		...
		var parts = this.Compiler.compile(this.string);

		this.strings = parts.strings;
		this.expressions = parts.expressions;
	},

	resolve: function(scope, map, bind){
		return this.Resolver.resolve(this.expressions, scope, map, bind);
	},

	get values(){
		var resolvedValues = this.resolvedValues;
		if( resolvedValues == null ){
			resolvedValues = this.resolvedValues = this.resolve(null);
		}
		return resolvedValues;
	},

	exec: function(scope){
		this.resolvedValues = this.resolve(scope);
		return this;
	},
