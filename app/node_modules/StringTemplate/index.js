...
var StringTemplate = proto.create({
	...
	populate: function(template){
		...
		this.compilationResult = template.compilationResult;
...
StringTemplate.cacheGetter = function(property, prefix){
	...
	Object.defineProperty(this, property, {
		get: function(){
			if( this.hasOwnProperty(cachedPropertyName) ){
				value = this[cachedPropertyName];
			}
			else{
