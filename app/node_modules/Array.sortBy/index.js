...
var Comparer = proto.create({
	...
	createDistinctions: function(args){
		...
		for(;i<j;i++){
			...
			if( typeof arg === 'function' ){
				distinctions.push(new Distinction(arg));
			}
				...
				distinctions.push(new Distinction(this.createDistinctionGetter(arg)));
			}	
		}
	...
	addDistinction: function(valueGetter, order){
		var distinction = new Distinction(valueGetter, order);
		this.distinctions.push(distinction);
	},

	compare: function(a, b){
		var distinctions = this.distinctions, i = 0, j = distinction.length, distinction, va, vb;
...
module.exports = {
	...
	sortBy: function(array){
		var comparer = new Comparer(Array.prototype.slice.call(arguments, 1));
