...
Object.eachPropertyIn = function(array, propertyIterator, fn, bind){
...
if( 'getOwnPropertyDescriptor' in Object ){
	...
	Object.appendPair = Object.implementPair = function(key, value, object){
		this[key] = value;
	};
...
Object.append = function(object){
	Object.eachPropertyIn(Array.prototype.slice.call(arguments, 1), Object.eachOwnPair, Object.appendPair, object);
	return object;
};
...
Object.complete = function(object){
	Object.eachPropertyIn(Array.prototype.slice.call(arguments, 1), Object.eachOwnPair, Object.completePair, object);
	return object;
};

Object.implement = function(){
	Object.eachPropertyIn(arguments, Object.eachOwnPair, Object.implementPair, this.prototype);
};
...
Object.complement = function(){
	Object.eachPropertyIn(arguments, Object.eachOwnPair, Object.complementPair, this.prototype);
};
...
Object.implement({
	supplement: function(){
		Object.eachPropertyIn(arguments, Object.eachPair, Object.appendPair, this);
		return this;
	},
