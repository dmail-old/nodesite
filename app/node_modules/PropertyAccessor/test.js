testModule('../index', function(PropertyAccessor){
	...
	it('read the correct value for parts', function(){
		...
		expect(path.firstPart.value).toBe(model.user);
		expect(path.firstPart.nextPart.value).toBe(model.user.comment);
		expect(path.lastPart.value).toBe('titre');
	});
