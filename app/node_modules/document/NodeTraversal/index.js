var NodeTraversal = {
	...
	firstChild: function(fn, bind){
		...
		if( this.firstChild ){
			return NodeTraversal.nextSibling.call(this.firstChild, fn, bind, true);
		}
	...
	lastChild: function(fn, bind){
		...
		if( this.lastChild ){
			return NodeTraversal.previousSibling.call(this.lastChild, fn, bind, true);
		}
	...
	first: function(fn, bind){
		return NodeTraversal.next.call(this, fn, bind, this);
	},
	...
	last: function(fn, bind){
		...
		return NodeTraversal.previous.call(node, fn, bind, this);
	}
};

module.exports = NodeTraversal;

/*
// public API
Object.eachPair(NS.TraversalMethods, function(name, method){
	NodeTraversal[name] = function(){
