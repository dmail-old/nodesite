...
testModule('Array.iterate', function(iterate){

	it('call fn on every element of the array', function(){
		var calls = [];
		iterate([0, 1, 2, 3], function(value){
			calls.push(value);
		});
	...
	it('get the index as second argument', function(){
		var calls = [];
		iterate(['a', 'b', 'c'], function(value, index){
			calls.push(index);
		}, null, 'prev');
	...
	it('call fn on every element from an index to an other index', function(){
		var calls = [];
		iterate(['a', 'b', 'c', 'd', 'e'], function(value){
			calls.push(value);
		}, null, 'next', 0, 2);
