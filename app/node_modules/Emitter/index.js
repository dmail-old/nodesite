...
var NotifierPrototype = require('Notifier');

var Notifier = NotifierPrototype.create({
	name: null,
	bind: null,
...
var Emitter = proto.create({
	...
	onAdd: Notifier.new(),
	onRemove: Notifier.new(),
	onNotify: Notifier.new(),
