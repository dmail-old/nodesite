...
var ListIterator = proto.createFrom(Iterator, {
	list: null,
	direction: 'next',
	from: null,
	to: null,
	...
	init: function(list, direction, from, to){
		this.list = list;
...
var IterableList = proto.create({
	...
	'@@iterator': function(){
		return ListIterator.new.apply(ListIterator, this.args);
	}
});

module.exports = IterableList;	