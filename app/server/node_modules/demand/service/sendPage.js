module.exports = {
	...
	sendPage: function(){
		var filePath = global.CLIENT_PATH + '/skeleton.html';
	...
	parsePage: function(error, html){
		...
		if( config.debug ){
			var testFiles = FS.readdirSync(global.CLIENT_PATH + '/tests');
			testFiles = testFiles.map(function(fileName){ return '/tests/' + fileName; });
		...
		var data = {
			...
			'head_scripts': this.parseScripts([
				'/js/path',
				'js/module'
			]),
			'scripts': this.parseScripts(jsFiles),
