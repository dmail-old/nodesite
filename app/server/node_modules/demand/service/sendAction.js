module.exports = {
	...
	getScriptPath: function(pathname){
		if( !pathname.endsWith('.js') ) pathname+= '.js';

		return global.SERVER_PATH + pathname;
	},
	...
	sendScriptResponse: function(path, args){
		...
		var relative = Path.relative(global.SERVER_PATH, path);
