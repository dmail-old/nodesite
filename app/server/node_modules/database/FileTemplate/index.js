...
je pense qu'au lieu de faire des sous classes qui héritent de FileParser
FileParser est très bien comme ça JSONFileParser n'a besoin de rien
C'est seulement les parties qui sont créé qui changent

var parser = FileParser.new('pathtofile');

// par défaut ce serais json
parser.setContentType('json');
parser.setContentType('csv');

var parser = FileParser.new('pathtofile.json');
// ceci mettrais auto à json
var parser = FileParser.new('pathtofile.csv');
// ceci auto à csv

// on émet une erreur lorsque le contentType n'est pas supporté

y'a que record parser avec ses méthodes comme find, update qui est utile*
qu'on va surement renommer DBFile
