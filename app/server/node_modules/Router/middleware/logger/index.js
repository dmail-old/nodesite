	...
	request: {
		...
		get stringScope(){
			...
			Object.keys(headers).forEach(function(k){
				headerString+= StringTemplate.format('{key}: {value}\n', {
					key: k,
					value: headers[k]
				});
			});
		...
		toString: function(){
			return StringTemplate.new(this.stringTemplate).render(this.stringScope);
		}
	},

	response: {
		stringTemplate: 'HTTP/1.1 {statusCode} {statusMessage}\n{headers}',
