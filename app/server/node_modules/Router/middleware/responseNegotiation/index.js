...
var ResponseProperties = {
	Stream: require('stream').PassThrough,//require('ProcessedStream'),
	cachedStream: null,
	...
	get stream(){
		if( this.cachedStream === null ){
			...
			*/
			...
			this.serverResponse.on('pipe', this.redirectPipe.bind(this));	
		}
	...
	redirectPipe: function(readableStream){
		readableStream.unpipe(this.serverResponse);
