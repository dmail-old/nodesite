...
wrap avec auto content-length à vérifier selon quand j'apelle wrap à mon avis ça chie
...
var ResponseProperties = {
	...
	bodyEncoding: 'indentity', // by default data are considered not encoded
	bodyCharset: 'utf8', // by default data are considered using utf8 charset
	...
	validHeaders: function(){
		...
		if( charset ){
			...
			if( charset != 'utf8' ) this.removeHeader('content-length');
		...
		if( encoding ){
			...
			if( encoding != 'identity' ) this.removeHeader('content-length');
