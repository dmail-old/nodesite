...
var Response = proto.extend(Emitter, {
	...
	responseWriteHead: function(){
		...
		if( this.writeCalls ){
			...
			return this.ServerResponse.prototype.writeHead.apply(this.serverResponse, arguments);
		}	
	},
	...
	responseWrite: function(chunk, encoding){
		...
		return this.ServerResponse.prototype.write.call(this.serverResponse, chunk, encoding);
	},
	...
	responseEnd: function(chunk, encoding){
		...
		if( this.writeCalls ){
			...
			ret = this.ServerResponse.prototype.end.call(this.serverResponse);
		}
	...
	resume: function(){
		this.ServerResponse.prototype.writeHead.call(this.serverResponse, this.statusCode);
		this.writeCalls.forEach(function(args){
			this.ServerResponse.prototype.write.apply(this.serverResponse, args);
		}, this);
		this.writeCalls = null;
		this.ServerResponse.prototype.end.call(this.serverResponse);
	},
