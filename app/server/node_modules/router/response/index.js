...
var Response = proto.create({
	...
	populate: function(properties){
		if( properties && properties instanceof Response ) return;
...
[
	...
	if( plugin.dependencies && !plugin.dependencies.every(Response.prototype.hasPlugin, Response.prototype) ){
		throw new Error('missing request plugin');
	}

	Response.prototype.plugins.push(plugin);
	if( plugin.properties ) Object.define(Response.prototype, plugin.properties);
	if( plugin.task ) Response.prototype.tasks.push(plugin.task);
});
