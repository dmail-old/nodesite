...
-> réécrire pageURLS qui doit s'apelle pageResolver et ne doit pas forcément travailler qu'avec CLIENT_PATH
...
var PageHandler = Handler.extend({
	...
	handle: function(router){
		// la résolution doit se faire en asynchrone
		if( PageURLS.isPage(router.request.pathname) ){
			return PageHandler.new(router).send();
		}
		else{
			router.next();
		}
