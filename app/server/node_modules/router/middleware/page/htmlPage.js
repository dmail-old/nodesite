...
au lieu de parse c'est render partout parse c'est pas la même chose

dans parse:

on cherche tout les {%(.*?)%} hors d'une balise script et on remplace direct
ensuite on cherche tout les  {%(.*?)%} dans la balise script et on fait JSON.stringify dessus
