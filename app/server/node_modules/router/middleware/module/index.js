...
le tableau dependencies seras en synchronisation avec un fichier
ce tableau seras rempli de path du type: './app/module', 'module'
au chargement de la page app.html
on crée un object: moduleURLS = {};
pour chaque path de dependencies on resolve l'url
si l'url se resolve moduleURLS['./app/module'] = './node_modules/app/module';
si l'url se résout pas on remove cette dépendance (le module a surement été supprimé ou déplacé)
