...
exports['request md5'] = function(test, RequestMD5){
	...
	test.resolveTo(goodRequest.consume().then(function(){ return goodRequest.bodyMD5; }), md5);
	test.resolveTo(badRequest.consume().catch(function(error){ return error.code; }), 'BAD_DIGEST');
};