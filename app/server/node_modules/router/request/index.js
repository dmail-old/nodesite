...
var Request = proto.extend({
	...
	resolve: function(properties){
		...
		var taskPromise = Promise.reduce(this.tasks, this);

		taskPromise = taskPromise.then(function(){
			return this;
		}.bind(this));

		this._resolve(taskPromise);
	},
...
var Factory = require('@dmail/proto/factory');
var RequestFactory = Factory.extend({
	productConstructor: function(){
		// request.tasks must not be shared
		this.tasks = [];
	},
...
Request.extendProto = function(){
	return RequestFactory.create(arguments).produce(this);
};
