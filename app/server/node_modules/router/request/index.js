...
var Request = proto.create({
	...
	hooks: {
		...
		headers: function(headers){
			if( headers == null ) this.headers = this.constructor.prototype.headers;
		},

		cookies: function(cookies){
			if( cookies == null ) this.cookies = this.constructor.prototype.cookies;
		},
...
Request.extend = function(plugins){
	...
	plugins.forEach(function(plugin){
		customRequest.prototype.addPlugin(plugin);
	});

	return customRequest;
};

Object.defineProperty(Request.prototype, 'stream', {
	enumerable: false,
	configurable: true,
	value: null
});
