...
var Router = proto.extend({
	...
	constructor: function(options){
		...
		this.RequestHandler = this.RequestHandler.extend({
			Request: this.RequestHandler.Request.extendProto.apply(
	...
	use: function(middleware){
		...
		if( middleware.properties ){
			Object.define(this.RequestHandler, middleware.properties);
		}
