...
var RequestHandler = proto.create({
	...
	constructor: function(router, requestProperties){
		...
		this.responsePropertiesPromise = this.request.populate(requestProperties).then(function(){
		...
		this.responsePromise = this.responsePropertiesPromise.then(function(responseProperties){
			...
			return this.response.populate(responseProperties);
		}.bind(this));
...
var Router = proto.create({
	...
	use: function(middleware){
		...
		if( middleware.properties ){
			proto.define(this.RequestHandler.prototype, middleware.properties);
		}
	...
	route: function(clientRequest, serverResponse){
		this.createClientRequestHandler(clientRequest).then(function(response){
