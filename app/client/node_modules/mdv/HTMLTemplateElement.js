if( typeof window.HTMLTemplateElement === 'undefined' ){
	...
	window.HTMLTemplateElement.supported = false;
}
else{
	window.HTMLTemplateElement.supported = true;
}

Object.append(window.HTMLTemplateElement, {
	contentDescriptor: {
		get: function(){
	...
	appendPrototype: function(node){
		if( !this.isNativeTemplate(node) ){
			this.mixin(node, window.HTMLTemplateElement.prototype);
...
if( window.HTMLTemplateElement.supported === false ){
	window.HTMLTemplateElement.prototype = Object.create(window.HTMLUnknownElement.prototype);
	Object.defineProperty(window.HTMLTemplateElement.prototype, 'content', this.contentDescriptor);
}

Object.append(window.HTMLTemplateElement.prototype, {
