...
var TokenLinker = proto.extend.call(DirectLinker, {
	name: 'TokenLinker',
	prefix: '',
	suffix: '',

	constructor: function(nodeAttribute, modelPath, prefix, suffix){
		TokenLinker.super.constructor.call(this, nodeAttribute, modelPath);
		this.prefix = prefix;
		this.suffix = suffix;
	},
	...
	link: function(node, model){
		var self = this;
		var specificModel = {};
		Observer.create(this.modelPath, model, function(change){
