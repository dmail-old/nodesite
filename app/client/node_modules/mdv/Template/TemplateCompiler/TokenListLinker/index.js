...
var TokenListLinker = proto.extend.call(Linker, {
	ComputedObserver: require('Observer').ComputedObserver,
	name: 'TokenListLinker',
	nodeAttribute: null,
	stringTemplate: null,

	constructor: function(nodeAttribute, stringTemplate){
	...
	link: function(node, model){
		...
		observer = this.ComputedObserver.create();
		for(;i<j;i++){
