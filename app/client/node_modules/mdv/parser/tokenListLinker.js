...
var TokenListLinker = Linker.extend({
	...
	link: function(node, model){
		var stringTemplate = this.stringTemplate;
		...
		// now the computedBinding is resolved, combinator becomes different
		// it replace only what has been modified
		computedBinding.combinator = function(values){
			var lastChange = computedBinding.lastChange;
			return stringTemplate.replaceOne(stringTemplate.parse(), lastChange.alias, lastChange.value);
		};
	},
