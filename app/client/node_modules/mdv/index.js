...
if( typeof window.HTMLTemplateElement === 'undefined' ){
	...
	MDV.supported = false;
	MDV.templateElementPrototype = Object.create(window.HTMLUnknownElement.prototype);
	Object.defineProperty(MDV.templateElementPrototype, 'content', MDV.contentDescriptor);

}
else{
	MDV.supported = true;
	MDV.templateElementPrototype = window.HTMLTemplateElement.templateElementPrototype;
}
