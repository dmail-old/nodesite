var EventProperties = {
	...
	get page(){
		...
		else if( this.type == 'click' || this.type == 'dblclick' || 
			this.type == 'contextmenu' || this.type == 'DOMMouseScroll' || this.type.startsWith('mouse') ){
...
if( typeof Event !== 'undefined' ){
	require('property').implement(Event, EventProperties);
}