function Element(tag, props){
	return tag in Element.constructors ? Element.constructors[tag](props) : document.createElement(tag, props);
}

Element.constructors = {};
Element.prototype = window.Element.prototype;

var pair = require('Object.util');
Element.implement = pair.implement.bind(pair, Element);
Element.complement = pair.complement.bind(pair, Element);
