...
en premier lieu faut trouver un fichier ou un dossier
en cherchant dans client/node_modules et /node_modules
...
module.exports = {
	...
	sendFileModule: function(path){
		...
		var filepath = pathname.slice(pathname.indexOf('/node_modules/') + '/node_modules/'.length);
	...
	resolveModule: function(filename, callback, bind){
		bind = bind || this;
		var self = this;
		var sharedNodeModulesDirectory = global.ROOTPATH;
		var clientNodeModulesDirectory = global.CLIENTPATH;
		...
		var clientModule = clientNodeModulesDirectory + Path.sep + 'node_modules' + Path.sep + filename;
		var sharedModule = sharedNodeModulesDirectory + Path.sep + 'node_modules' + Path.sep + filename;
