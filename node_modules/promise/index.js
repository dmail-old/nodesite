...
var Promise = proto.extend({
	...
	clean: function(){
		if( this.pendingList ){
			...
			// doing this would make unhandledrejection think there is no listeners
			// have to check how I can set pendingList to null without impacting unhandledrejection
		}
	},
