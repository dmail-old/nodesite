...
var ChildPromise = proto.extend.call(Promise, {
	parent: null,
	onresolve: null,
	onreject: null,
...
ChildPromise = ChildPromise.constructor;
...
Promise.all = function(iterable){
	return new Promise(function allExecutor(resolve, reject){
...
var force = true;
if( 'Promise' in global && Promise.polyfill ) force = false;
