...
TestLoader.load(modulePath) -> returns an array of test file for this module
...
var TestLoader = {
	...
	loadFromFolder: function(path){
		...
		try{
			...
			return this.fileSystem.readdirSync(path).filter(this.filterFile, this).map(function(name){
