...
var ModuleFinder = proto.create({
	...
	find: function(path, badSignature, ignoreFile){
		...
		for(;i<j;i++){
			...
			if( this.fileSystem.statSync(filePath).isDirectory() ){
				...
				modulePaths = modulePaths.concat(this.find(filePath, badSignature, modulePath != null));
				modulePath = null;
			}
			/*
