...
var Logger = DuplexStream.prototype.extend({
	ansi: require('ansi'),
	...
	_read: DuplexStream.prototype.read,
	...
	pipe: function(stream){
		...
		if( stream.isTTY ){
			DuplexStream.prototype.pipe.call(this, stream);
		}
		// and raw data for other streams
		else{
			if( this.rawStream == null ) this.rawStream = new Stream.PassThrough();
