...
var Table = proto.extend({
	...
	Graph: require('dependency-resolver'),
	cells: null,
	compiled: false,
	...
	column: function(x){
		...
		else if( CellRange.isPrototypeOf(x) ){
			return x;
		}
		else if( Cell.isPrototypeOf(x) ){
	...
	row: function(y){
		...
		else if( CellRange.isPrototypeOf(y) ){
			return y;
		}
		else if( Cell.isPrototypeOf(y) ){
			return this.row(y.y);
		}
		else{
			var foundCell = null;
