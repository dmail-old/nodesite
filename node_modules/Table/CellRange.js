...
var CellRangeIterator = proto.extend(Iterator, {
...
var CellRange = proto.create({
	...
	addDependency: function(requiredCell){
		if( requiredCell instanceof CellRange ){
...
CellRange.prototype[Symbol.iterator] = function(){
	...
	return new CellRangeIterator(this.cells, this.x, this.y, width, height);
};
