...
var exports = {
	Collector: require('./Collector-task'),
	...
	*/
	...
	collectModulePaths: function(path, fn, bind){
		...
		fn = fn || console.log;
		bind = bind || console;
		return this.Collector.create(path).resolve(fn, bind);
	},
	...
	comparer: function(moduleA, moduleB){
		return exports.getDependencyLevel(moduleA) - exports.getDependencyLevel(moduleB);
	},
	...
	sortModules: function(modules){
		...
		modules.forEach(function(module){
			graph.add(module, module.children);
		});
