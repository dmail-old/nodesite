var ansi = {
	...
	writeFormat: function(string, format){
		format = typeof format === 'string' && format in this.formats ? this.formats[format] : format;
		return this.stylize.apply(this, [string].concat(format));
	},
	...
	addFormat: function(format){
		this.formats[format] = Array.prototype.slice.call(arguments, 1);
		/*
		if( !(format in this) ){
	...
	register: function(formats){
		for(var format in formats){
			this.addFormat.apply(this, [format].concat(formats[format]));
		}
	}
};
