...
var StackTrace = {
	...
	get: function(error, belowFn){
		...
		if( error ){
			...
			if( typeof error.stack == 'object' ) return error.stack;
		}
		else{
			error = {};
		}

		belowFn = belowFn || StackTrace.get;

		var oldLimit = Error.stackTraceLimit, oldPrepare = Error.prepareStackTrace, stack;

		//Error.stackTraceLimit = Infinity; 
		Error.prepareStackTrace = function(obj, rawStack){ return rawStack; };
		Error.captureStackTrace(error, belowFn);
