...
var Log = ConsoleTemplate.create({
	level: null,
	suffix: '\n',
	...
	init: function(string, level){
		...
		this.level = level;
		ConsoleTemplate.init.call(this, string);
	},
	...
	toString: function(){
		...
		output+= ConsoleTemplate.toString.call(this);
	...
	toStylizedString: function(){
		...
		output+= ConsoleTemplate.toStylizedString.call(this);

		return output;
	},

	toJSON: function(){
		var obj = ConsoleTemplate.toJSON.call(this);
