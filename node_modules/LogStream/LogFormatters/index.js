...
var JSONStream = proto.extend(StringFormattedStream, {
	stringify: function(log){
		return JSON.stringify(log);
	}
});

var RawStream = proto.extend(StringFormattedStream, {
	stringify: function(log){
		return log.toString();
	}
});

var ColoredStream = proto.extend(StringFormattedStream, {
	stringify: function(log){
...
var Log = require('../Log');
var ConsoleTemplate = Object.getPrototypeOf(Log.prototype).constructor;

var LogStream = proto.extend(JSONParsedStream, {
	reviveLogFromData: function(data){
		...
		if( typeof data == 'object' && 'string' in data && 'scope' in data ){
			if( 'level' in data ){
				...
				var consoleTemplate = new ConsoleTemplate();
