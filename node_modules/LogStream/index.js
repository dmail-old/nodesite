...
var LogStream = proto.createFrom(TransformStream.prototype, {	
	...
	init: function(options){
		//this.constructor.apply(this, arguments); // or
	...
	log: function(level, message, data){
		if( this.canLog(level) ){
			...
			var fn;
			if( this.nextLogCallback ){
				fn = this.nextLogCallback;
				this.nextLogCallback = null;
			}
