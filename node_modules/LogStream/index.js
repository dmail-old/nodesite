...
var LogStream = proto.createFrom(PassThrough.prototype, {	
	...
	*/
	...
	createLog: function(level, message, data, styles){
		var log = this.Log.new.apply(this.Log, arguments);
	...
	addLog: function(level, message, data, styles){
		return this.writeLog(this.createLog.apply(this, arguments));
	}
});

LogStream.addStyleGroup({
	//'log': {},
	'info': 'green',
	'help': 'cyan',
	'warn': ['yellow', 'bold'],
...
LogStream.levels.forEach(function(level){
	LogStream[level] = function(){
		return this.addLog.apply(this, [level].concat(Array.apply(Array, arguments)));
	};
});
