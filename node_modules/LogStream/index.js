...
var LogStream = proto.extend(PassThrough, {
	Log: require('./Log'),
	...
	*/
	...
	getStream: function(type){
		...
		if( type in this.formats ){
			...
			stream = new this.formatters[type]();
	...
	pipe: function(stream, options){
		...
		// use this stream, emitting object
			...
			return PassThrough.prototype.pipe.call(this, stream, options);
		}
	},
	...
	registerStyles: function(styles){
		return this.Log.prototype.registerStyles(styles);
	}
});

LogStream.prototype.levels.forEach(function(level){
	LogStream.prototype[level] = function(message, data, styles, fn){
