...
var LogStream = proto.createFrom(PassThrough.prototype, {	
	...
	*/
	...
	writeLog: function(level, message, data, fn){
		if( this.canLog(level) ){
			if( arguments.length > 4 || typeof data != 'object' ){
				data = Array.prototype.slice.call(arguments, 2);
				if( typeof data[data.length - 1] == 'function' ) fn = data.pop();
			}

			var log = this.Log.new(level, message, data);
...
LogStream.levels.forEach(function(level){
	LogStream[level] = function(){
		return this.writeLog.apply(this, [level].concat(Array.apply(Array, arguments)));
	};
});
