...
String.implement = property.implement.bind(property, String);
String.complement = property.complement.bind(property, String);
...
function pad(string, size, motif, direction){
	...
	if( size + 1 >= length ){
		if( direction === 'left' ){
			...
			string = motif.repeat(left) + string + motif.repeat(right);
		}
	}
