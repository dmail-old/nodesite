...
var Watcher = {
	...
	filterDirectory: function(path, stat){
		return stat.isDirectory() === false;
	},

	watch: function(path, callback, filter){
		...
		if( filter && filter(path, stat) === false ) return;
		...
		if( stat.isDirectory() ){
			...
			files.forEach(function(name){ this.watch(path + '/' + name, callback, filter); }, this);
			return;
		}
