...
var Symbol = proto.extend({
	constructor: function(key){
		if( Symbol.isPrototypeOf(this) ) throw new TypeError('TypeError: Symbol is not a constructor');
		return HiddenSymbol.create(key);
	}
});
...
require('@dmail/object/polyfill')('global', 'Symbol', Symbol);