...
var Task = proto.create({
	...
	get value(){
		return this.pendingValue.value;
	},
...
Task.all = function(iterable){
	return new Task(function(resolve, reject){		
		function res(value, index){
			if( PendingValue.prototype.checkThenable(value, function(value){ res(value, index); }, reject) ){
				return;
			}
			values[index] = value;
			length--;
