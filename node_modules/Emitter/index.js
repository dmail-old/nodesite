...
var EventNotifier = proto.extend(Notifier, {
	name: null,
	bind: null,
	...
	execListener: function(listener, args){
		listener.bind = typeof listener.fn == 'object' ? this.objectMethod : this.bind;
		return Notifier.prototype.execListener.apply(this, arguments);
	}
});
...
var Emitter = proto.create({
	...
	*/
	...
	constructor: function(bind){
		this.bind = bind || this;
		this.notifiers = Emitter.prototype.notifiers === null ? {} : Object.create(Emitter.prototype.notifiers);
	},

	createNotifier: function(name){
		return new this.Notifier(name);
	},
