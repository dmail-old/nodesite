exports['can add listener without instantiating the emitter'] = function(Emitter, assert){
...
exports['call listener'] = function(Emitter, assert){
...
exports['isListened'] = function(Emitter, assert){
...
exports['preserve add order when calling listeners'] = function(Emitter, assert){
...
exports['add volatile listener'] = function(Emitter, assert){
...
exports['remove all listeners for specific event'] = function(Emitter, assert){
	var emitter = Emitter.new();
...
exports['remove all listeners'] = function(Emitter, assert){
	var emitter = Emitter.new();
...
exports['work with multiple events'] = function(Emitter, assert){
...
exports['accept object with handleEvent as listener'] = function(Emitter, assert){
