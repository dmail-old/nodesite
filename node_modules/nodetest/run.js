...
TODO: lorsqu'un test échoue, les tests suivants ne sont pas relancé!!!
...
var appTest = new ModuleTestSerie(appPath);
...
appTest.load(function(e, ms){
	if( e ){
		...
		if( true ){
			// this listener is called when a module/test file is modified
			appTest.observe(function(test){
				// if the test is running just notify it has changed
				if( test.running ){
					test.changed = true;
				}
				else{
