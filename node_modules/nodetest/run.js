...
function handleResult(e){
	if( e ){
		...
		logger.info('{count} modules tested in {duration} ms', {
...
function handleRestartResult(e){
	if( e ){
		...
		logger.info('{count} tests passed in {duration} ms', {
			count: this.tests,
			duration: this.duration
		});
	}
...
appTest.load(function(e, ms){
	if( e ){
		...
		logger.info('{count} modules prepared for testing in {duration} ms', {
			count: appTest.tests.length,
