...
var Assertion = proto.create({
	...
	createError: function(){
		...
		if( this.name == 'equal' ){
			error.message+= ' ' + this.args[0] + ' not equal to ' + this.args[1];
		}
...
var Test = proto.create({
		...
		promise.then(
			...
			function(value){
				...
				if( this.pendingCount === 0 ){
					...
					this.reject(new Error('promise expecting to resolve is rejected with ' + value));
				}
			}.bind(this)
		);
	},
	...
	createTimeoutError: function(){
		var error = new Error(this + ' test is too slow (more than ' + this.timeout + ' ms)');
	...
	setTimeout: function(timeout){
		...
		this.timer = setTimeout(function(){
			...
			this.onTimeout(this.createTimeoutError());
		}.bind(this), timeout);
	},
