...
var Test = proto.create({
	...
	exec: function(){
		...
		}, this).setTimeout(100).then(function(){
...
var FolderTest = proto.create({
	...
	findModulePaths: function(folderPath){
		...
		}, this).then(function(modulePaths){
	...
	/* filterTestModules: function(modulePaths){
		return modulePaths.filter(function(modulePath){
			var basename = this.PATH.basename(path);
			return basename == 'test.js' || basename.slice(-8) === '-test.js' || basename.slice(-5) == '.test';
		}, this);
	}
	*/
