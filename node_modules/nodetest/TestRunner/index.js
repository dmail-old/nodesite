...
var Test = proto.create({
	...
	assert: function(type, args){
		...
		assertion.checkThrow(); // will throw
	},	
...
var TestRunner = {
	test: function(fn, module){
		...
		return task.then(function(){
			return {duration: new Date() - start, count: test.assertions.length};
		});
	},
	...
	testFile: function(filePath, module, options){
		...
		return task.then(function(){
			return {duration: new Date() - start, count: testFile.tests.length};
		});
	},
	...
	testModule: function(modulePath, options){
		...
		return task.then(function(){
			return {duration: new Date() - start, count: moduleTest.testFiles.length};
		});
	},
	...
	testFolder: function(folderPath, options){
		...
		return task.then(function(){
			return {duration: new Date() - start, count: folderTest.moduleTests.length};
		});
	}
};
