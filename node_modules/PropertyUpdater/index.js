var proto = {
	constructor: function(set){
		if( set ) this.set = set;
		this.update = this.setAll.bind(this);
	},

	set: function(object, name, owner){
...
var PropertyUpdater = proto.constructor;
PropertyUpdater.prototype = proto;
