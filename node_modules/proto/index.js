...
var exports = {
	...
	getConstructor: function(proto, defaultConstructor){
		...
		if( !('create' in constructor) ) constructor.create = exports.new;
	...
	create: function(proto){
		...
		for(;i<j;i++) Object.implement(constructor.prototype, arguments[i]);
	...
	extend: function(parentConstructor, proto){
		proto = proto || {};
		if( !parentConstructor ) throw new TypeError('parentConstructor must be an object or function');
		...
		var i = 2, j = arguments.length;
		Object.implement(constructor.prototype, proto);
		for(;i<j;i++){
			Object.implement(constructor.prototype, arguments[i]);
		}

		constructor.prototype.super = parentConstructor;
	...
	define: function(proto){
		...
		var i = 1, j = arguments.length;
		for(;i<j;i++){
			Object.define(object, arguments[i]);
		}
		return proto;
	},
...
Function.prototype.create = exports.new;
