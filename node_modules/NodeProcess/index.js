...
var NodeProcess = proto.extend.call(Emitter, {
	Path: require('path'),
	...
	constructor: function(args){
		NodeProcess.super.constructor.call(this);

		this.passedArgs = this.args = args;

		var path = args[0], configPath = args[1] || args.config;
	...
	observeFile: function(path){
		FileObserver.observe(path, this.onFileChange, this);
	},

	unobserveFile: function(path){
		FileObserver.unobserve(path, this.onFileChange, this);
	},
