...
var TableLayout = proto.extend({
	...
	constructor: function(tableTemplate){
		...
		// debug('table dimensions', 'container', this.containerWidth, 'available', this.availableWidth, 'width', this.width);
	},
	...
	computeWidths: function(){
		...
		*/
		...
		for(;i<j;i++){
			...
			columnLayout = ColumnLayout.create(column, this.availableWidth);
