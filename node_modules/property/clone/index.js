...
var exports = {
	...
	assignCloneProperty: function(name, target, owner, references){
	...
	cloneProperties: function(object, references){
		...
		if( typeof object === 'object' && object !== null ){
			if( typeof object.clone === 'function' ){
				...
				while(i--){
					this.defineCloneProperty.call(this, names[i], target, object, references);
				}
...
exports.defineCloneProperty = exports.assignCloneProperty;
...
if( 'getOwnPropertyDescriptor' in Object ){
	Object.define(exports, {
		...
		defineCloneProperty: function(name, target, owner, references){
	...
	exports.cloneMethod = exports.defineCloneProperty;
}
