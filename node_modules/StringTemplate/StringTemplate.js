...
require('property/merge'); // Object.merge
...
var StringTemplate = proto.create({
	...
	clone: function(){
		var tpl = this.new(this.string);// proto.new.call(this, this.string);
		tpl.populate(this);
		return tpl;
	},
	...
	format: function(string, scope){
		return StringTemplate.new(string).render(scope);
	},
