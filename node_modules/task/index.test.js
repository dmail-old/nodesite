...
exports['pause prevent completion & resume restore state'] = function(test, Task){
	...
	return test.near(task.then(function(){ return new Date(); }), now + 100, 40);
};
...
exports['pause propagate pausing to consumer & resume restore state'] = function(test, Task){
	...
	return test.near(subTask.then(function(){ return new Date(); }), now + 100, 40);
};

exports['delay'] = function(test, Task){
	var now = Number(new Date());
	return test.near(Task.complete(10).delay(100).then(function(){ return new Date(); }), now + 100, 40);
};
