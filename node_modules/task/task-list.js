...
var TaskList = proto.extend.call(Task, {
	...
	add: function(value){
		...
		this.pendingCount++;
/*
if( task.isCancelled ) this.onTaskCancellation();
if( task.isPaused ) this.onTaskPausing();
else task.paused.addOnce(this.onTaskPausing, this);
if( task.state === 'completed' ) this.onTaskCompletion(task);
else task.completed.addOnce(this.onTaskCancellation, this);

donc créer une sorte de Notifier spécial
qui lorsqu'il a été notifié une fois le sait
et appelle immédiattement les listeners ensuite
