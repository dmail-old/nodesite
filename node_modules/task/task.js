...
var Task = proto.extend({
	...
	previous: null,
	nextList: null,
	propagation: 'both', // 'left', 'right', 'both', 'none'
	...
	notify: function(name, arg){
		if( name in this.listeners ){
			this.listeners[name].call(this.bind, this, arg);
		}
	},
	...
	propagate: function(method){
		...
		var propagation = this.propagation, left = false, right = false;

		if( propagation === 'both' ) left = right = true;
		else if( propagation === 'left' ) left = true;
		else if( propagation === 'right' ) right = true;
